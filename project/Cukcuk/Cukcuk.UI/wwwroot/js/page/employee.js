    ...
    * */
    ...
    getDataFromDialog() {
        try {
            ...
            debugger
            emp.Gender = parseInt($('#sltGender').val());

            emp.DateOfBirth = $('#txtDateOfBirth').val();
            ...
            emp.IssuedDate = new Date();
            emp.JoinDate = new Date();
            return emp;
        } catch (e) {
            console.log(e);
        }
        ...
        try {
            ...
            $.ajax({
                ...
                if (!response) {
                    ...
                    $('#txtDateOfBirth').val(commonJS.formatDatetoShow(response.dateOfBirth));
